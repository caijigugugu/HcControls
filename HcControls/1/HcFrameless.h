...
class HcFrameless : public QQuickItem, QAbstractNativeEventFilter {
    Q_OBJECT
    ...
    QML_NAMED_ELEMENT(HcFrameless)
public:
    explicit HcFrameless(QQuickItem *parent = nullptr);

    ~HcFrameless() override;
