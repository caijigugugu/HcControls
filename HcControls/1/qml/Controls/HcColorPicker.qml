...
Button{
    ...
    background: Rectangle{
        ...
        border.color: {
            if(hovered)
                return HcTheme.primaryColor
            return HcTheme.dark ? Qt.rgba(100/255,100/255,100/255,1) : Qt.rgba(200/255,200/255,200/255,1)
        }
        border.width: 1
        Rectangle{
            anchors.fill: parent
                    ...
                    Row{
                        ...
                        HcTextBox{
                            ...
                            HcText{
                                ...
                                color: "#323232"
                                anchors.verticalCenter: parent.verticalCenter
                                x:Math.min(text_box_a.implicitWidth,text_box_a.width)-40
                            }
                            onTextEdited: {
                                if(text!==""){
