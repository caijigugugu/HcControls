            ...
            Column{
                ...
                move: Transition {
                    NumberAnimation {
                        ...
                        duration: HcTheme.animationEnabled ? 333 : 0
                    }
                }
        ...
        Component{
            ...
            Item{
                ...
                HcLoader{
                    ...
                    sourceComponent:itemcomponent ? itemcomponent : mcontrol.hcSytle
                }
            }
        }
        property Component hcSytle:  Rectangle{
            ...
            Row{
                ...
                HcIcon{
                    iconSource:{
                        switch(_super.type){
                        case mcontrol.const_success: return HcIcons.CompletedSolid
                        case mcontrol.const_warning: return HcIcons.InfoSolid
                        case mcontrol.const_info:    return HcIcons.InfoSolid
                        case mcontrol.const_error:   return HcIcons.StatusErrorFull
                        }HcIcons.StatusErrorFull
                        return HcIcons.FA_info_circle
                    }
                    iconSize:20
                    iconColor: {
                        if(HcTheme.dark){
                            ...
                            case mcontrol.const_info:    return HcTheme.primaryColor
