    ...
    Menu{
        ...
        contentItem: Item{
            ...
            RowLayout{
                        ...
                        Rectangle{
                            ...
                            color: {
                                if(getListView().currentIndex === position){
                                    return  item_mouse.containsMouse ? Qt.lighter(HcTheme.primaryColor,1.1): HcTheme.primaryColor
                                }
                ...
                ListView{
                    id:list_view_2
                    Layout.preferredWidth: showYear ? parent.width/3 -1 : parent.width/2
                    Layout.preferredHeight: parent.height - 2
                    Layout.alignment: Qt.AlignVCenter
                    clip: true
                    ScrollBar.vertical: HcScrollBar {}
