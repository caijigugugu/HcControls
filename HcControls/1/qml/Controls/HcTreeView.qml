...
Rectangle {
    ...
    property color lineColor: HcTheme.dividerColor
    property color borderColor: HcTheme.dark ? Qt.rgba(37/255,37/255,37/255,1) : Qt.rgba(228/255,228/255,228/255,1)
    property color selectedBorderColor: HcTheme.primaryColor
    property color selectedColor: HcTools.withOpacity(HcTheme.primaryColor,0.3)
    ...
    Component{
        ...
        Item{
            ...
            Flickable{
                ...
                TextArea.flickable: HcMultilineTextBox {
                    id:text_box
                    text: String(display)
                    readOnly: true === control.columnSource[column].readOnly
                ...
                Component{
                    ...
                    HcIconButton{
                        ...
                        contentItem:HcIcon{
                            ...
                            iconSource:HcIcons.ChevronDown
                            iconSize: 16
            ...
            Rectangle{
                ...
                color:{
                    ...
                    if(d.rowHoverIndex === row || item_table.isRowSelected){
                        return HcTheme.dark ? Qt.rgba(1,1,1,0.06) : Qt.rgba(0,0,0,0.06)
                    }
                    return (row%2!==0) ? control.color : (HcTheme.dark ? Qt.rgba(1,1,1,0.015) : Qt.rgba(0,0,0,0.015))
                }
                Item{
                    anchors.fill: parent
    ...
    Component{
        ...
        Rectangle{
            ...
            color: HcTheme.dark ? Qt.rgba(50/255,50/255,50/255,1) : Qt.rgba(247/255,247/255,247/255,1)
            Rectangle{
            ...
            MouseArea{
                ...
                onPressed :
                    (mouse)=>{
                        HcTools.setOverrideCursor(Qt.SplitHCursor)
                        clickPos = Qt.point(mouse.x, mouse.y)
                    }
                onReleased:{
                    HcTools.restoreOverrideCursor()
                }
                onCanceled: {
                    HcTools.restoreOverrideCursor()
                }
            ...
            HcText {
                ...
                color:{
                    if(itemMouse.pressed){
                        return HcTheme.dark ? HcColors.Grey80 : HcColors.Grey120
                    }
                    return HcTheme.dark ? HcColors.White : HcColors.Grey220
                }
            }
        }
    }
