...
QtObject {
    ...
    //组件框架边框色
    readonly property color tempFrameBorderColor: "#A2A2A2"
    readonly property color tempFrameDeepBorderColor: "#101111"
    ...
    //组件阶段边框色
    readonly property color tempStageBorderColor: "#B5B5B5"
    readonly property color tempStageDeepBorderColor: "#131616"
    ...
    //pcr温度线条颜色
    readonly property color tempLineColor: "#0DBECC"

    //pcr温度按钮背景颜色
    readonly property color tempBtnBackground: "#FFFFFF"
    readonly property color tempBtnDeepBackground: "#505454"

    //logo标题栏
    readonly property Gradient headerRecGradient: Gradient {
        GradientStop {
            position: 0.0
            color: Qt.rgba(0/255, 156/255, 166/255, 0.83) //009ca6,左下角
        }

        GradientStop {
            position: 1.0
            color: Qt.rgba(0/255, 200/255, 215/255, 0.83) //00c8d7,右上角
        }
    }
    readonly property Gradient headerRecDeepGradient: Gradient {
        GradientStop {
            position: 0.0
            color: Qt.rgba(73/255, 79/255, 79/255, 0.83) //494f4f
        }

        GradientStop {
            position: 1.0
            color: Qt.rgba(52/255, 57/255, 57/255, 0.83) //343939
        }
    }
}
