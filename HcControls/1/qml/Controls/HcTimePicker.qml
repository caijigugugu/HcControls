...
HcButton {
    property int hourFormat: HcTimePickerType.H
    //是否为12小时制
    property int isH: hourFormat === HcTimePickerType.H
    ...
    Menu{
        ...
        contentItem: Item{
            id:container
            implicitHeight: layout_content.height + layout_actions.height
            ...
            RowLayout{
                        ...
                        Rectangle{
                            ...
                            color:  {
                                if(getListView().currentIndex === position){
                                    return  item_mouse.containsMouse ? Qt.darker(HcTheme.primaryColor,1.1) : HcTheme.primaryColor
                                }
                                if(item_mouse.containsMouse){
                                    return HcTheme.dark ? Qt.rgba(63/255,60/255,61/255,1) : Qt.rgba(237/255,237/255,242/255,1)
                                }
                            ...
                            HcText{
                                ...
                                color: {
                                    if(getListView().currentIndex === position){
                                        ...
                                        return HcTheme.dark ? "#FFFFFF" : "#1A1A1A"
                                    }
                                }
                ...
                ListView{
                    id:list_view_1
                    Layout.preferredWidth: isH ? parent.width/3 : parent.width/2
                ...
                ListView{
                    id:list_view_2
                    Layout.preferredWidth: isH ? parent.width/3 -1 : parent.width/2
                    Layout.preferredHeight: parent.height-2
                    Layout.alignment: Qt.AlignVCenter
            ...
            Rectangle{
                ...
                color: HcTheme.dark ? Qt.rgba(32/255,32/255,32/255,1) : Qt.rgba(243/255,243/255,243/255,1)
                border.color: HcTheme.dark ? Qt.rgba(26/255,26/255,26/255,1) : Qt.rgba(191/255,191/255,191/255,1)
                radius: 5
                anchors{
                    bottom:parent.bottom
                ...
                HcButton{
                    ...
                    onClicked: {
                        ...
                        if(control.hourFormat === HcTimePickerType.H){
                            if (hours === "12") {
