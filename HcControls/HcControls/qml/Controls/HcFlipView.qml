...
Item{
    ...
    Button{
        ...
        background: Rectangle{
            radius: 4
            color:HcTheme.dark ? Qt.rgba(45/255,45/255,45/255,0.97) : Qt.rgba(237/255,237/255,237/255,0.97)
        }
        contentItem:HcIcon{
            iconSource: vertical ? HcIcons.CaretUpSolid8 : HcIcons.CaretLeftSolid8
            width: 10
            height: 10
            iconSize: 10
            iconColor: btn_start.hovered ? HcColors.Grey220  :  HcColors.Grey120
    ...
    Button{
        ...
        contentItem:HcIcon{
            iconSource: vertical ? HcIcons.CaretDownSolid8 : HcIcons.CaretRightSolid8
            width: 10
            height: 10
            iconSize: 10
            iconColor: btn_end.hovered ? HcColors.Grey220  :  HcColors.Grey120
            anchors.centerIn: parent
        }
        onClicked: {
