...
T.RangeSlider {
    ...
    first.handle: Rectangle {
        ...
        implicitHeight: 20
        radius: width / 2
        color:HcTheme.dark ? Qt.rgba(69/255,69/255,69/255,1) :Qt.rgba(1,1,1,1)
        HcShadow{
            radius: 10
        }
        HcIcon{
            width: 10
            height: 10
            iconSource: HcentIcons.FullCircleMask
            iconSize: 10
            scale:{
            ...
            iconColor: HcTheme.primaryColor
    ...
    background: Item {
        ...
        Rectangle{
            ...
            anchors.margins: 1
            radius: 2
            color:HcTheme.dark ? Qt.rgba(162/255,162/255,162/255,1) : Qt.rgba(138/255,138/255,138/255,1)
        }
        Rectangle {
